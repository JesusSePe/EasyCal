const strings = {
   en: {
      ...
      HelpAdd: "Adds a new event to database. First, send the event name in a message, then the description and finally the event date. You can also set a hour. The date and time will be saved in UTC timeformat, so time may vary or even the day.",
   ...
   es: {
      ...
      HelpAdd: "Añade un evento a la base de datos. Primero se envía el nombre, después la descripción y por último la fecha del evento. También se puede enviar la hora. La fecha y hora se guarda en formato UTC, de modo que puede variar la hora e incluso el día.",
